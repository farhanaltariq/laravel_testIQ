          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="tables.php">
                ...
                <span class="nav-link-text">Tables Pembayaran</span>
              </a>
            </li>
            <li class="nav-item">
            ...
            <div class="col-xl-3 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Donatur</h5>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h3 font-weight-bold mb-0">Rp.50.000.000</span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  ...
                  <h5 class="h3 text-white mb-0">Peningkatan Donasi</h5>
                </div>
                <div class="col">
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row align-items-center">
                <div class="col">
                  <h6 class="text-uppercase text-muted ls-1 mb-1">Peforma</h6>
                  <h5 class="h3 mb-0">Total Donatur</h5>
                </div>
              </div>
            </div>
            <div class="card-body">
        ...
        <div class="row align-items-center justify-content-lg-between">
          <div class="col-lg-6">
            <div class="copyright text-center  text-lg-left  text-muted">
              &copy; 2022 <a href="#" class="font-weight-bold ml-1" target="_blank">Tim APPL</a>
            </div>
          </div>
          <div class="col-lg-6">
