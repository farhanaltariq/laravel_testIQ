...
require 'fungsi.php';
$data = query("SELECT * FROM sodaqoh")
?>
                ...
                <div class="col">
                    <div class="card">
                        ...
                        <div class="card-header border-0">
                            <h3 class="mb-0">Tabel Sodaqoh</h3>
                        </div>
                        <!-- Light table -->
                            ...
                            <table class="table align-items-center table-flush">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th scope="col" class="sort" data-sort="Pesan">Pesan</th>
                                        <th scope="col" class="sort" data-sort="Nominal Donalis">Nominal Donasi</th>
