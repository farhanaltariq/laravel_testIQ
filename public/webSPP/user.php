          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="tables.php">
                ...
                <span class="nav-link-text">Tables Donasi</span>
              </a>
            </li>
            <li class="nav-item">
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    <th scope="col" class="sort" data-sort="Nama">Nama User</th>
                      ...
                      <td class="text-right">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                            ...
                            <a class="dropdown-item" href="hapus1.php ?id=<?= $row["id"]; ?>" onclick="return confirm('anda yakin ingin menghapus data?')">Hapus</a>
                          </div>
                        </div>
                      </td>
                    </tr>
