...
<body>
		...
		<div class="container">
			...
			<nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
				<ul class="nav navbar-nav">
					...
					<li>
						<a href="logout.php"><img src="assets/img/icons/png/110-log-out.png " width="30" alt="logout"></a>
					</li>
				</ul>
			</nav>
		</div>
	...
	<section class="c" style=" background-color: aliceblue; ">
		<div class="container">
			<div class="col-lg-12 ">
				...
				<div class="col-md-4 position-relative">
					<div class="p-3 text-center">
						<a href="pembayaran.php"><img src="assets/img/icons/assistance.png" alt="sodaqoh" width="100"></a>
					...
					<div class="col-md-4">
						<a href="assets/img/main/g1.jpg" title="This is the description">
							...
							<div class="description">
								<span class="caption">Berbagi itu <b>Indah</b></span>
	...
	<section id="credits" class="text-center">
		...
		Copyright &copy; <a href="#">Tim APPL</a>
	</section>
