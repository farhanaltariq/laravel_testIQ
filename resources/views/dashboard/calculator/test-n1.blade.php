                ...
                <tbody>
                    @foreach ($n1 as $item)
                        ...
                        @php
                            ...
                            strtoupper($item->ans21) == strtoupper($answer[21]) ? $nilai += 1 : null;
                            strtoupper($item->ans22) == strtoupper($answer[22]) ? $nilai += 1 : null;
                            strtoupper($item->ans23) == strtoupper($answer[23]) ? $nilai += 1 : null;
                            strtoupper($item->ans24) == strtoupper($answer[24]) ? $nilai += 1 : null;
                            strtoupper($item->ans25) == strtoupper($answer[25]) ? $nilai += 1 : null;
                        @endphp
                    <tr>
                        <td>{{ $item->nama }}</td>
                        <td>{{ $nilai }} dari 25</td>
